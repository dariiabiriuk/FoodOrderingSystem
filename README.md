...
- Тип кухні: Визначає кулінарний напрямок (наприклад, "Італійська", "Японська").
- Рейтинг: Середня оцінка задоволеності клієнтів за шкалою від 0 до 5.

Ці атрибути дозволяють повноцінно представити будь-який ресторан у системі.
...
| _menu: Menu \| None | Об'єкт Menu, призначений ресторану, або None, якщо меню не встановлено.|
